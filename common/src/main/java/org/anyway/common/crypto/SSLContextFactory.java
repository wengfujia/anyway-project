...
public class SSLContextFactory {
    ...
    private static String CLIENT_KEY_STORE = "./resources/sslclientkeys";
    private static String CLIENT_TRUST_KEY_STORE = "./resources/sslclienttrust";
    private static String CLIENT_KEY_STORE_PASSWORD = "wengfujia@WENGFUJIA";
    private static String CLIENT_TRUST_KEY_STORE_PASSWORD = "wengfujia@WENGFUJIA";
    ...
    private static String SERVER_KEY_STORE = "./resources/sslserverkeys";
    private static String SERVER_TRUST_KEY_STORE = "./resources/sslservertrust";
    private static String SERVER_KEY_STORE_PASSWORD = "wengfujia@WENGFUJIA";
    private static String SERVER_TRUST_KEY_STORE_PASSWORD = "wengfujia@WENGFUJIA";
